...
if __name__ == '__main__':
    ...
    path_to_dir_raw_data='/mnt/MainNAS/temp/STRIPE_share_dir/data/raw/train'
    path_to_save_numpy_array_raw='/mnt/MainNAS/temp/STRIPE_share_dir/data/save/before_normalization/frame_raw.npy'
    path_to_save_numpy_array_normalized='/mnt/MainNAS/temp/STRIPE_share_dir/data/save/after_normalization/frame_norm_minmax.npy'
    ...
    #@TODO: writing from python on NAS
